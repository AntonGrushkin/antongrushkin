...
28. Прочитать книгу Грокаем алгоритмы 
...
3. Допилить текущий пет проект вот ссылка на его репо: https://github.com/AntonGrushkin/CRUD-Next.js. Этот пет проект простая CRUD таблица релизованная на стеке Next.js + Redux + MongoDB.
